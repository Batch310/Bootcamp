...
public interface TokenRepository 
	...
	public void insertToken(@Param("token") String tokek,
			@Param("email") String mail,
			@Param("used_for") String kue,
			@Param("expired_on") Date explorer);
	...
	public Boolean isMaxOtp(@Param("email") String burhan);
