...
public class UserRestControllers {
	...
	@GetMapping("/profile")
	public Resp<ProfileDTO> getProfile(@RequestParam("user_id") Long userId) {

		int code = 200;
		String message = "sukses";
		
		ProfileDTO dataUser = biodataService.getProfile(userId);
		if (dataUser == null) {
			code = 11;
	...
	public Resp<String> getUpload(@RequestParam("file") MultipartFile file, 
		...
		String imagePath = biodataService.upload(file, userId);
