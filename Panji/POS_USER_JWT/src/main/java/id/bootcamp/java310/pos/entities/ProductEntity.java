		...
		@SqlResultSetMapping(name = "product_results",
				classes = @ConstructorResult(
						...
						columns = {
								...
								@ColumnResult(name = "variant_name",type = Long.class),
								@ColumnResult(name = "initial",type = Long.class),
								@ColumnResult(name = "name",type = Long.class),
								@ColumnResult(name = "active",type = Long.class),
								@ColumnResult(name = "description",type = Long.class),
								@ColumnResult(name = "price",type = Long.class),
								@ColumnResult(name = "stock",type = Long.class)		
						}))
})
