...
//		String usernameAuth = (String) request.getSession().getAttribute("usernameAuth");
//		String passwordAuth = (String) request.getSession().getAttribute("passwordAuth");
		
		//Ngoper ke file htmlnya
		model.addAttribute("name", name);
		model.addAttribute("role_code", roleCode);
		model.addAttribute("profile_picture", profilePicture);
//		model.addAttribute("username_auth", usernameAuth);
//		model.addAttribute("password_auth", passwordAuth);
//		
		if (email != null) {
