...
public class Mutation implements GraphQLMutationResolver {
	...
	// --------------------------------- VARIANT ---------------------------------
	public Long createVariant(Long category_id, String initial, String name, Boolean active, String createBy)
			throws Exception {
		...
		return vs.createVariant(variantDTO);
	}

	public Boolean updateVariant(Long category_id, Long id, String initial, String name, Boolean active,
