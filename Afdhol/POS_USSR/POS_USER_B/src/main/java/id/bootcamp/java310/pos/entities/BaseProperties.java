...
@MappedSuperclass //membantu agar tidak perlu membuat berulang-ulang
public class BaseProperties {
	...
	@JsonIgnore
	private UserEntity userWhoModified;
	...
	public UserEntity getUserWhoModified() {
		return userWhoModified;
	}

	public void setUserWhoModified(UserEntity userWhoModified) {
