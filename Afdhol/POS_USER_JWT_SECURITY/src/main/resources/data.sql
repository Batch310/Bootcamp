...
VALUES 
	(true, 3, now(), 'A', 'ANT', 'Antis Hand Sanitazer Liquid', 42000, 100, 1, false),
	(true, 3, now(), 'B', 'DTL', 'Dettol Hand Sanitazer Bottle', 62000, 100, 1, false),
	...
	(true, 3, now(), 'I', 'SK4', 'Stop Kontak 4 Lubang', 40000, 100, 5, true),
	(true, 3, now(), 'J', 'USK', 'Uticon Stop Kontak Kabel', 175000, 100, 5, true)
;