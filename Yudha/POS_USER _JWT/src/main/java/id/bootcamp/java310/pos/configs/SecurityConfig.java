...
public class SecurityConfig {
	...
	@Bean // biar fungsi bisa dipanggil siapa saja
	...
	@Bean
	public AuthenticationManager autenAuthenticationManager(AuthenticationConfiguration authConfig) throws Exception{
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
		...
		http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(authEntryPointJwt).and().authorizeHttpRequests()
		...
		.anyRequest().authenticated()// setelah permit all, harus auth
		.and()
