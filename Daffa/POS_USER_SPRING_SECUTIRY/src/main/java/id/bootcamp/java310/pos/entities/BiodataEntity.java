...
@NamedNativeQueries(value = { @NamedNativeQuery(name = "profile_query", query = "select\r\n"
...
@SqlResultSetMappings(value = {
		@SqlResultSetMapping(name = "profile_result", classes = @ConstructorResult(targetClass = ProfileDTO.class, columns = {
				...
				@ColumnResult(name = "phone", type = String.class), @ColumnResult(name = "email", type = String.class),
